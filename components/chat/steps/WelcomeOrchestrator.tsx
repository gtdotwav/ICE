...
const messages = {
  ...
  Direct: "🚀 Bem-vindo(a) de volta! É ótimo ter você aqui para explorar o futuro das conversões.",
}
...
export const WelcomeOrchestrator = ({ source }: WelcomeOrchestratorProps) => {
  return (
    <div className="space-y-3">
      ...
      <p>
        Eu sou a IA da HIAS FLOW, e nos próximos 60 segundos, vou te mostrar como podemos transformar seus resultados.
        Vamos começar?
      </p>
    </div>
  )
